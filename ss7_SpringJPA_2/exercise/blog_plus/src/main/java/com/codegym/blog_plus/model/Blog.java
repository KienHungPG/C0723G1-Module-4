package com.codegym.blog_plus.model;
...
public class Blog {
    ...
    public Blog(Integer id, String introduction, String image, String title, String content, LocalDateTime dateWriting, Category category) {
        this.id = id;
